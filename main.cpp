...
static DigitalOut led_green(MBED_CONF_APP_LIGHT_0, 0);
static DigitalOut led_yellow(MBED_CONF_APP_LIGHT_1, 0);
static DigitalOut led_red(MBED_CONF_APP_LIGHT_2, 0);
